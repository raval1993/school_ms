...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'signature.max' => 'The :attribute size must be under 3mb.',
        ...
        $rules =  [
            ...
            'photo' => 'nullable|mimes:jpeg,jpg,png|max:5120|dimensions:min_width=150,min_height=150',
            'signature' => 'nullable|mimes:jpeg,jpg,png|max:3076|dimensions:max_width=3000,max_height=3000',
            'designation' => 'max:255',
